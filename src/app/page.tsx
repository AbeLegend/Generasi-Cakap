...
//        "desktop:grid desktop:grid-cols-8 desktop:gap-x-4 desktop:px-32 desktop:pt-28 desktop:overflow-hidden",
//      ])}
//    >
//      {/* BEGIN: Image */}
//      <div
...
//          "desktop:w-[400px] desktop:aspect-square desktop:m-0 desktop:col-span-3 desktop:col-start-6 desktop:order-2 desktop:items-center",
//        ])}
//      >
//        <Image alt="human-standing" src={HumanStandingImage} objectFit="cover" />
//      </div>
//      {/* END: Image */}
...
//        <Button
//          mode="primary"
//          className={cn(["mb-[29px] uppercase", "desktop:p-4 desktop:text-2xl"])}
//        >
//          Daftar Sekarang
//        </Button>
//        {/* END: Button */}
...
//            ])}
//          >
//            Bangun hubungan dengan mentor untuk dukungan karir yang berkelanjutan
//          </p>
//        </Card>
//      </div>
//    </section>
...
//        </p>
//        <div
//          className={cn(["grid grid-cols-12 gap-4", "tab:mt-8", "desktop:mt-8"])}
//        >
//          <Card
//            className={cn([
//              "col-span-6 m-0",
...
//              ])}
//            >
//              Bangun jaringan dengan mentor, pelajari kiat sukses dari pengalaman
//              mereka
//            </p>
//          </Card>
//          <Card
...
//        ])}
//      >
//        Generasi Cakap merupakan start-up psikologi & edukasi (psiedukasi) yang
//        berfokus dalam pengembangan diri dan program untuk membangun dukungan
//        sosial psikologis bagi generasi usia produktif dalam mengembangkan diri
//        di dunia karir.
//      </p>
//      <p
//        className={cn([
...
//        berfokus dalam pengembangan diri dan program untuk membangun dukungan
//        sosial psikologis bagi generasi usia produktif dalam mengembangkan diri
//        di dunia karir. <br /> <br />
//        Melalui program edukasi, riset dan pengembangan serta pendampingan
//        psikologis, kami mendampingi organisasi/ perusahaan Anda dalam manajemen
//        talenta, pelatihan dan pengembangan karyawan,dll. <br /> <br />
//        Saat ini, Generasi Cakap berada di bawah naungan Yayasan Generasi Cahaya
//        Kebaikan yang didirikan berdasarkan hukum negara Republik Indonesia.
//      </p>
//    </section>
//    {/* END: Section 12 */}
//    {/* BEGIN: Section 13 */}
...
//        Lorem ipsum dolor sit amet consectetur. Integer accumsan sed malesuada
//        aliquam blandit pharetra sed felis et. Ac pulvinar in et sem. Est et
//        faucibus tincidunt et nibh nibh. Velit turpis pharetra a condimentum eget
//        semper.
//      </p>
//      <div
//        className={cn([
...
//      </div>
//      <p
//        className={cn([mulish.className, "text-sm text-neutral-900 font-bold"])}
//      >
//        Contact Us
//      </p>
//      <div className="flex gap-x-3 my-4">
...
//        ])}
//      >
//        Jalan Semarang No. 17, Antapani Kidul, Kec. Antapani, Kota Bandung 40291
//      </p>
//      <div
//        className={cn([
//          mulish.className,
